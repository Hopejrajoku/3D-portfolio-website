    ...
    <Tilt className='xs:w-[250px] w-full'>
      ...
      >
       ...
       >
        ...
        <h3 className='text-wite text-[20px] font-bold text-center'>{title}</h3>
       </div>
      </motion.div>
...
const About = () => {
  return (
    <>
     ...
     >
      I am a passionate Frontend Developer with a knack for creating visually stunning and functional web applications. Skilled in HTML, CSS, JavaScript, and frameworks like React and Angular, I excel in building responsive, user-friendly interfaces.
